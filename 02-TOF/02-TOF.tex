...
distributions. The plots in Fig.~\ref{fig:SlabDtAll} show that they
all centre approximately at 0~ns and they exhibit very similar
resolutions, with TOF1 having the largest spread.
Fig.~\ref{fig:TOF_peaks} shows an example of measurement of time of
flight between first two stations, TOF0 and TOF1. Times of electrons,
...
$\sim$0.11~ns is about 30\%~larger than the calculated spread from a
naive addition of slab \DT{} of the individual TOF stations. This
difference is attributed to contributions to the resolution of
individual stations which cancel out in the slab \DT{} measurement,
and to variations in the traveled path length of the electrons between
