...
\begin{figure}[htb!]
  \begin{center}
    ...
    \caption{Photoelectron spectra in CkovA (left) and CkovB (right) for muons (green) and pions (blue) above (continuous line) and below (dashed line) the threshold. The distributions are normalised.}
    \label{fig:ckov3}
  \end{center}
\end{figure}
